-- ==============================================================================
-- RESTROZ MIGRATION: FIX mark_order_payment_verified PAYMENT METHOD MAPPING
-- File: 20260915000001_fix_payment_method_mapping.sql
-- Description:
--   1. Maps order-domain payment methods ('online' -> 'upi', 'cod' -> 'cash')
--      to satisfy the public.payments payment_method CHECK constraint ('cash', 'card', 'upi', 'room', 'split').
--   2. Preserves all verified schema alignments, strict tenant isolation,
--      role-based authorization (SUPER_ADMIN, RESTAURANT_ADMIN, RESTAURANT_STAFF),
